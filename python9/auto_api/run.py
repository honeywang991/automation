...
if __name__ == '__main__':
    ...
    conf_path = read_path.pro_path + '\conf\pro.conf'
    mode=ReadConfig().read_config(conf_path,'MODE','mode')
    case_id_list=ReadConfig().read_config(conf_path,'MODE','case_id_list')
